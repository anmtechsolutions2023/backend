...
exports.delete = (id, tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiondetaillog.delete
...
exports.getAll = (tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiondetaillog.fetchAll
...
exports.update = (updatedReq, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiondetaillog.update
...
exports.create = (req, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiondetaillog.create
    let reqId = uuidv4()
      ...
      (err, res) => {
        if (err) {
          logger.loggerHelper(
            ...
            logger.logType.error,
            `Error while creating record for ${req.AccountTypeBaseId}-${req.BranchDetailId}, Error Code: ${err.code} , Error: ${err}`
          )
