...
exports.delete = (id, tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.paymentmodetransactiondetail.delete
...
exports.getAll = (tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.paymentmodetransactiondetail.fetchAll
...
exports.update = (updatedReq, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.paymentmodetransactiondetail.update
...
exports.create = (req, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.paymentmodetransactiondetail.create
    let reqId = uuidv4()
      ...
      (err, res) => {
        if (err) {
          logger.loggerHelper(
            ...
            logger.logType.error,
            `Error while creating record for ${req.PaymentModeId}-${req.RefNo}, Error Code: ${err.code} , Error: ${err}`
          )
