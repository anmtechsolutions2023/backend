...
exports.delete = (id, tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiontypeconversionmapper.delete
...
exports.getAll = (tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiontypeconversionmapper.fetchAll
...
exports.update = (updatedReq, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiontypeconversionmapper.update
...
exports.create = (req, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactiontypeconversionmapper.create
    let reqId = uuidv4()
      ...
      (err, res) => {
        if (err) {
          logger.loggerHelper(
            ...
            logger.logType.error,
            `Error while creating record for ${req.TransactionTypeBaseCoversionId}-${req.TransactionDetailLogId}, Error Code: ${err.code} , Error: ${err}`
          )
