...
exports.delete = (id, tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactionitemdetail.delete
...
exports.getAll = (tenantId, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactionitemdetail.fetchAll
...
exports.update = (updatedReq, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactionitemdetail.update
...
exports.create = (req, username) => {
  return new Promise((resolve, reject) => {
    let query = moduleScripts.transactionitemdetail.create
    let reqId = uuidv4()
      ...
      (err, res) => {
        if (err) {
          logger.loggerHelper(
            ...
            logger.logType.error,
            `Error while creating record for ${req.TransactionDetailLogId}-${req.ItemId}, Error Code: ${err.code} , Error: ${err}`
          )
